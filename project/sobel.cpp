...
BENCHMARK(BENCH_Sobeluint8InputImplementation)->DenseRange(0, 0, 1);
BENCHMARK(BENCH_Sobeluint8InputImplementationLoopUnroll)->DenseRange(0,0,1);
BENCHMARK(BENCH_Sobeluint8Input1DArray)->DenseRange(0,0,1);
BENCHMARK(BENCH_Sobeluint8Input1DArrayMathOperationReorder)->DenseRange(0,0,1);
BENCHMARK(BENCH_Sobeluint8MathOperationReorder)->DenseRange(0,0,1);
