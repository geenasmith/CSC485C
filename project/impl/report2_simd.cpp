...
namespace OMPCoarse
{
std::string implementation = base + "_" + "OMP_COARSE";
...
} // namespace simd openmp coarse

namespace OMPFine
{
std::string implementation = base + "_" + "OMP_FINE";
...
// namespace UInt8
// {
// std::string implementation = base + "_" + "Uint8";
...
//             __m256i r0 = _mm256_cvtepu8_epi32(_mm_loadu_si64(&(img.input[r][c])));
//             __m256i r1 = _mm256_cvtepu8_epi32(_mm_loadu_si64(&(img.input[r+1][c]))); // calculated row
//             __m256i r2 = _mm256_cvtepu8_epi32(_mm_loadu_si64(&(img.input[r+2][c])));
